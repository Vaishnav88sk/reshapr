...
/**
 * Factory abstraction over the converter implementation under benchmark.
 *
 ...
 * {@code OpenAPIGetCallResponseBenchmark}. Both implementations will then be measured side by side.</p>
 *
 * @author laurent
 */
public interface ConverterFactory {
   ...
   Map<String, ConverterFactory> FACTORIES = Map.of(
         "current", OpenAPIMcpToolConverter::new,
         "optimized", OptimizedOpenAPIMcpToolConverter::new
   );
